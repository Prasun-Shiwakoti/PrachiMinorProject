...
urlpatterns =[
    ...
    path('exam/<int:user>/', examsection_view, name='examsection_view'),
    path('addresult/<int:semester>/<int:batch>/<str:faculty>/<str:exam_type>/<int:user>/', addresult_view, name='addresult_view'),
